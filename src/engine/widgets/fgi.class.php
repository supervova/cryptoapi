 ...
 *
 * Подготавливает данные и рендерит шаблон widgets/fgi.twig с индикатором индекса
 * страха и жадности.
 */

declare(strict_types=1);

// маршрут: /projects/cryptoapi.ai/widgets/fgi
...
$data_objects['widget'] = [
    ...
    'lang'  => $lng,
    'aff'   => $aff,
    'fgi'   => $data_objects['site']['header_stats']['fgi'],
];

// 4) рендер Twig
$final_html = get_template('widgets/fgi.twig');
