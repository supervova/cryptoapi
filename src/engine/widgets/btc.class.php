...
/**
 * Контроллер виджета графика Биткоина
 *
 * Подготавливает данные и рендерит шаблон widgets/btc.twig с графиком.
 */

declare(strict_types=1);

// маршрут: /projects/cryptoapi.ai/widgets/btc
...
// 4) рендер Twig
$final_html = get_template('widgets/btc.twig');
