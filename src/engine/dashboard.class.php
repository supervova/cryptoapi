...
$data_objects['ExtraData'] = [
    ...
    'desc' => 'Monitor the crypto market in real time, get trading signals, and manage AI-powered agents for smarter, faster trading decisions.',
    'domain' => $host,
    ...
    // Реальные данные можно получать откуда угодно — из базы, API, файла
    // 'watchlist' => [
...
// $data_objects['ExtraData']['header_stats'] = [3.78, -25.3];
